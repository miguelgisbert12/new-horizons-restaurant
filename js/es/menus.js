...
const Plantilla_menus = document.getElementById("plantilla_menus");
...
Menu_hamburguesa_verde.addEventListener("click", function() {
    ...
    if (menu_abierto === false) {
        ...
        Plantilla_menus.style = "display: none; opacity: 0";
        ...
        Plantilla_menus.style = "display: flex; opacity: 0";
...
function salir() {
    if (menu_abierto === false) {
        ...
        Plantilla_menus.style = "opacity: 1; transition: opacity 0.5s";
    }
...
contenedor_cambio.addEventListener("click", () => {
    window.location = "../../html/es/postres.html";
});
...
preload(
    "../../media/img/Imagenes/Menus_y_combinados/burguer_especial_menu.jpg",
    "../../media/img/Imagenes/Fondos/editadas/menu_bocadillo.jpg",
    "../../media/img/Imagenes/Fondos/editadas/combinado_naranja_edit.jpg"
);
