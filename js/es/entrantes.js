...
const Plantilla_entrantes = document.getElementById("plantilla_entrantes");
...
Menu_hamburguesa_verde.addEventListener("click", function() {
    ...
    if (menu_abierto === false) {
        ...
        Plantilla_entrantes.style = "display: none; opacity: 0";
        ...
        Plantilla_entrantes.style = "display: flex; opacity: 0";
...
function salir() {
    if (menu_abierto === false) {
        ...
        Plantilla_entrantes.style = "opacity: 1; transition: opacity 0.5s";
    }
...
contenedor_cambio.addEventListener("click", () => {
    window.location = "../../html/es/principales.html";
});
...
preload(
    "../../media/img/Imagenes/Entrantes/bollos_vapor.jpg",
    "../../media/img/Imagenes/Fondos/editadas/ensalada_atun.jpg",
    "../../media/img/Imagenes/Fondos/editadas/platano_frito.jpg",
    "../../media/img/Imagenes/Fondos/editadas/rollitos_vegetales.jpg",
    "../../media/img/Imagenes/Fondos/editadas/tostada_huevo.jpg",
    "../../media/img/Imagenes/Entrantes/tostadas_brocoli.jpg"
);
