...
const Plantilla_postres = document.getElementById("plantilla_postres");
...
Menu_hamburguesa_verde.addEventListener("click", function() {
    ...
    if (menu_abierto === false) {
        ...
        Plantilla_postres.style = "display: none; opacity: 0";
        ...
        Plantilla_postres.style = "display: flex; opacity: 0";
...
function salir() {
    if (menu_abierto === false) {
        ...
        Plantilla_postres.style = "opacity: 1; transition: opacity 0.5s";
    }
...
contenedor_cambio.addEventListener("click", () => {
    window.location = "../../html/es/bebidas.html";
});
...
preload(
    "../../media/img/Imagenes/Postres/avena_fresas.jpg",
    "../../media/img/Imagenes/Postres/tarta_chocolate.jpg",
    "../../media/img/Imagenes/Postres/cereales.jpg",
    "../../media/img/Imagenes/Fondos/editadas/macaroons.jpg",
    "../../media/img/Imagenes/Fondos/editadas/mandarinas.jpg",
    "../../media/img/Imagenes/Postres/kiwi.jpg"
);
