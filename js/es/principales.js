...
const Plantilla_principales = document.getElementById("plantilla_principales");
...
Menu_hamburguesa_verde.addEventListener("click", function() {
    ...
    if (menu_abierto === false) {
        ...
        Plantilla_principales.style = "display: none; opacity: 0";
        ...
        Plantilla_principales.style = "display: flex; opacity: 0";
...
function salir() {
    if (menu_abierto === false) {
        ...
        Plantilla_principales.style = "opacity: 1; transition: opacity 0.5s";
    }
...
contenedor_cambio.addEventListener("click", () => {
    window.location = "../../html/es/menus.html";
});
...
preload(
    ...
    "../../media/img/Imagenes/Fondos/editadas/merluza_pimientos.jpg",
    "../../media/img/Imagenes/Principales/poke.jpg",
    "../../media/img/Imagenes/Principales/tallarines_remolacha.jpg",
    "../../media/img/Imagenes/Principales/brochetas.jpg"
);
